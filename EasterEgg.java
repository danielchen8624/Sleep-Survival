...
public class EasterEgg
{
    ...
    class Drawing extends JComponent
    {
        public void paint (Graphics g)
        {
            ...
            g.drawString ("Congratulations! You found the easter egg! Unfortunately you cannot sleep.", 40, 120);
            Font largeSerifFont = new Font ("MAIN MENU", Font.PLAIN, 30);
            g.setFont (largeSerifFont);
            g.drawString ("SLEEP SURVIVAL", 100, 80);
            g.drawString ("Exit!", 190, 185);
            ...
            int[] xQuad = {440, 470, 470, 440, 410, 410};
            int[] yQuad = {180, 210, 220, 250, 220, 210};
            g.fillPolygon (xQuad, yQuad, 6);
