...
public class LevelOne2
{
    ...
    public LevelOne2 ()
    {
        JFrame frame = new JFrame ("Level One2");
    ...
    class Drawing extends JComponent
    {
        public void paint (Graphics g)
        {
            ...
            g2d.fillRoundRect (430, 140, 30, 80, 50, 30);


            Font largeSerifFont = new Font ("Level 1", Font.PLAIN, 25);
            g.setFont (largeSerifFont);
            g.drawString ("Exercise ", 70, 130);

            g.drawString ("Brush your ", 250, 130);
            g.drawString ("Teeth", 260, 160);
