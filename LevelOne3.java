...
public class LevelOne3
{

    public LevelOne3 ()
    {
        JFrame frame = new JFrame ("Level One3");
    ...
    class Drawing extends JComponent
    {
        public void paint (Graphics g)
        {
            ...
            g2d.fillRoundRect (430, 120, 30, 100, 50, 30);


            Font largeSerifFont = new Font ("Level 1", Font.PLAIN, 25);
            g.setFont (largeSerifFont);
            g.drawString ("Do the Dishes ", 35, 130);

            g.drawString ("Drink Coffee", 245, 130);
