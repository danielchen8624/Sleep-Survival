//level three win by daniel

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

public class LevelThreeW
{
    ...
    class Drawing extends JComponent
    {
        public void paint (Graphics g)
        {
            ...
            g.drawString ("You just beat level 3!", 100, 110);
            g.drawString ("You can now fall asleep!", 90, 140);
