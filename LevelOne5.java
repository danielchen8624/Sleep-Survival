...
public class LevelOne5
{

    public LevelOne5 ()
    {
        JFrame frame = new JFrame ("Level One5");
    ...
    class Drawing extends JComponent
    {
        public void paint (Graphics g)
        {
            ...
            g2d.fillRoundRect (430, 80, 30, 140, 50, 30);


            Font largeSerifFont = new Font ("Level 1", Font.PLAIN, 25);
            g.setFont (largeSerifFont);
            g.drawString ("Make Your Bed ", 25, 130);

            g.drawString ("Do Homework", 235, 130);
