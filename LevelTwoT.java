//level 2 tutorial by daniel
import java.awt.event.MouseAdapter;
import java.awt.event.MouseEvent;
import javax.swing.*;
import java.awt.*;

public class LevelTwoT
{
    ...
    class Drawing extends JComponent
    {
        public void paint (Graphics g)
        {
            ...
            g.drawString ("Welcome to Level two. Level two is a maze. However, it is not a normal", 15, 100);
            g.drawString ("maze - there is no exit! There will be different collectibles throughout ", 10, 120);
            g.drawString ("the maze. You will know whether to collect them or not from what you ", 10, 140);
            g.drawString ("learned in level one! Collecting the wrong items will result in losing the", 10, 160);
            g.drawString ("level. To move on, collect all items that will aid you in sleeping. ", 10, 180);
            g.drawRect (180, 200, 100, 40);
