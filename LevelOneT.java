...
public class LevelOneT
{
    ...
    class Drawing extends JComponent
    {
        public void paint (Graphics g)
        {
            ...
            g.drawString ("Welcome to Level one. Level one has 6 chapters. In each chapter, you", 20, 100);
            g.drawString ("will be presented with two choices. One choice will help you sleep, but", 10, 120);
            g.drawString ("the other will prevent you from sleeping. To pass level one, you must", 10, 140);
            g.drawString ("pick the choice that helps you sleep for each chapter. Choosing the  ", 10, 160);
            g.drawString ("wrong option will result in you losing, and having to restart the level. ", 10, 180);
